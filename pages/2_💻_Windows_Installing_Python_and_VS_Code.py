...
Follow the steps from the following video to download the Miniconda installation file for your Windows laptop.
""")        
...
miniconda_install_win_video = "screen_rec/win/install_miniconda_win_edited.mp4"  
...
Follow the steps from the following video to download the VS Code installation file for your Windows laptop.
""")        
...
Follow the steps from the video to install and set up VS Code for Python and Jupyter Notebooks on your Windows laptop.
""")        

vs_code_installation_win_video = "screen_rec/win/install_setup_vs_code_win_edited.mp4"  

play_video(vs_code_installation_win_video)
